      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
         ...
         {{--  <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('checkoutpage')}}"><i class="fab fa-opencart" id="item_count"></i></a>
          </li>
          @guest
          <li class="nav-item">
          ...
          <li class="nav-item dropdown">
            ...
            {{-- <form id="logout-form" action="{{ route('profilepage') }}" method="POST" style="display: none;">
              @csrf
            </form> --}}
